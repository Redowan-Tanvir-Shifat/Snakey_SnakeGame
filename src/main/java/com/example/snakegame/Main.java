...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        Image image = new Image("SnakeyMain.jpg");
...
//                if (code == KeyCode.RIGHT || code == KeyCode.D || code == KeyCode.LEFT || code == KeyCode.A || code == KeyCode.UP || code == KeyCode.W || code == KeyCode.DOWN || code == KeyCode.S) {
//                    for (int i = 0; i < 3; i++) {
